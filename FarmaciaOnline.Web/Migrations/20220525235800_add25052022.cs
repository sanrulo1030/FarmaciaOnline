...
{
    public partial class add25052022 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RouteAdministration = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Medicines_Repositories_RepositoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Laboratories_Medicines_MedicineId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Laboratories_MedicineId",
                table: "Laboratories",
                column: "MedicineId");

            migrationBuilder.CreateIndex(
                name: "IX_Laboratories_Name_MedicineId",
                table: "Laboratories",
                columns: new[] { "Name", "MedicineId" },
                unique: true,
                filter: "[MedicineId] IS NOT NULL");

            migrationBuilder.CreateIndex(
                name: "IX_Medicines_Name_RepositoryId",
                table: "Medicines",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Medicines_RepositoryId",
                table: "Medicines",
                column: "RepositoryId");
